  ...
  return (
    <div className='flex flex-col w-3/4 sm:w-3/4 md:w-2/4 lg:w-1/3 mx-auto py-28'>
      <div className='flex justify-center items-center gap-2 pb-5'>
        <h2 className='text-[32px] font-medium font-serif tracking-wider '>Create Account</h2>
      ...
      <form onSubmit={handleSubmit} className='w-full flex flex-col gap-2'>
        ...
        <input className='px-3 py-2 border border-black w-full mb-3' type='name' placeholder='Name' required value={name} onChange={(e)=>{setName(e.target.value)}} />
      ...
      <div className='flex justify-between gap-10 text-sm text-gray-600'>
        ...
        <Link to='/login'><p className='hover:text-black transition duration-300'>Login</p></Link>
      </div>
